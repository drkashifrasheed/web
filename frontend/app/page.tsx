          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            <div className="order-2 lg:order-1">
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 mb-8 sm:mb-10">
                ...
                <Link
                  href="/video-call"
                  className="inline-flex items-center justify-center gap-2 px-5 sm:px-6 py-3 min-h-[48px] bg-white text-gray-700 font-semibold rounded-lg border border-gray-300 hover:border-blue-400 hover:text-blue-600 transition-colors w-full sm:w-auto"
                >
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">15-30 min sessions</p>
                  </div>
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: 'Connect with the doctor from home via secure video calls.',
                features: ['HD video calls', 'Digital prescriptions', 'Follow-up care'],
                color: 'orange',
                link: '/video-call'
              },
              {
